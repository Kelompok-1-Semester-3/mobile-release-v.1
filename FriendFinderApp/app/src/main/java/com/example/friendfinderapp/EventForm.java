...
public class EventForm extends AppCompatActivity {
    ...
    // form credential
    private String event_name, event_owner, contact_person, description,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_event_picture = findViewById(R.id.btn_event_picture);
        ...
        Button btn_submit_add_new_event = findViewById(R.id.btn_submit_add_new_event);
        btn_submit_add_new_event.setOnClickListener(v -> {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, ConfigurationAll.urlUpload, response -> {
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(EventForm.this);
